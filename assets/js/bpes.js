            ...
            resultDisplay.innerHTML = `
                <div class="result-wrapper">
                    <div class="result-meta">
                        ...
                        <p><strong>Total Credits for the Semester:</strong> 18.00</p>
                    </div>
                    <div class="result-card">
                        ...
                        <div class="result-details">
                            ...
                            <div class="subject-orbit">
                                <div class="subject-item">${getSubjectDisplay('ENG201', result['ENG201'])}</div>
                                <div class="subject-item">${getSubjectDisplay('HCP201', result['HCP201'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PBI201', result['PBI201'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PED225', result['PED225'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PED229', result['PED229'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PED231', result['PED231'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PED233', result['PED233'])}</div>
