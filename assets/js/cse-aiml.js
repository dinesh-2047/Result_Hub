...
async function loadCSV(year, semester) {
    try {
        const filePath = `/assets/csvs/cse-aiml/results_${year}_sem${semester}.csv`;
...
const semesterDetails = {
    '1': { subjects: ['AEC0010', 'CE101', 'CSE111', 'CSE113', 'ME105', 'PHY107', 'PHY115', 'PT101', 'PT103', 'PT105', 'VAC022'], totalCredits: '22.00' },
