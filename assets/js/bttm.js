...
async function loadCSV(year, semester) {
    try {
        ...
        const filePath = `/assets/csvs/bttm/results_${year}_sem${semester}.csv`;
            ...
            resultDisplay.innerHTML = `
                <div class="result-wrapper">
                    <div class="result-meta">
                        ...
                        <p><strong>Total Credits for the Semester:</strong> 24.00</p>
                    </div>
                    <div class="result-card">
                        ...
                        <div class="result-details">
                            ...
                            <div class="subject-orbit">
                                <div class="subject-item">${getSubjectDisplay('AEC0010', result['AEC0010'])}</div>
                                <div class="subject-item">${getSubjectDisplay('MDC003', result['MDC003'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PT161', result['PT161'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PT163', result['PT163'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PT165', result['PT165'])}</div>
                                <div class="subject-item">${getSubjectDisplay('PT167', result['PT167'])}</div>
                                <div class="subject-item">${getSubjectDisplay('TTM161', result['TTM161'])}</div>
                                <div class="subject-item">${getSubjectDisplay('TTM163', result['TTM163'])}</div>
                                <div class="subject-item">${getSubjectDisplay('TTM165', result['TTM165'])}</div>
                                <div class="subject-item">${getSubjectDisplay('TTM167', result['TTM167'])}</div>
                                <div class="subject-item">${getSubjectDisplay('TTM169', result['TTM169'])}</div>
                                <div class="subject-item">${getSubjectDisplay('VAC032', result['VAC032'])}</div>
                            </div>
